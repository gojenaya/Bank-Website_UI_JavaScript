...
//   if(window.scrollY > section1_coords.top) nav.classList.add('sticky');
//   else nav.classList.remove('sticky');

// });

//Sticky Navigation using Intersection Obvserver API
...
sliderBtnL.addEventListener('click', prevSlide);
